...
public class Health : MonoBehaviour
{
    ...
    public AudioClip deathNoise1;
    public AudioClip deathNoise2;
    public AudioClip deathNoise3;

    void Start()
    {
        deathNoise1 = Resources.Load<AudioClip>("enemyDeathNoise1");
    	deathNoise2 = Resources.Load<AudioClip>("enemyDeathNoise2");
    	deathNoise3 = Resources.Load<AudioClip>("enemyDeathNoise3");
