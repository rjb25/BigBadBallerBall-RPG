...
public class SoundManagerScript : MonoBehaviour {
	...
	void Start () {
        ...
        swordNoise = Resources.Load<AudioClip>("swordNoise");
        gunNoise = Resources.Load<AudioClip>("gunNoise");
        enemyDeathNoise1 = Resources.Load<AudioClip>("enemyDeathNoise1");
        enemyDeathNoise2 = Resources.Load<AudioClip>("enemyDeathNoise2");
        enemyDeathNoise3 = Resources.Load<AudioClip>("enemyDeathNoise3");
